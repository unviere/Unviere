document.addEventListener('DOMContentLoaded', () => {
  ...
  const gameTemplate = document.getElementById('event-card').content;
  const gameContainer = document.querySelector('.event-scroller');
...
var startDate = new Date(game.start);
var endDate = new Date(game.end);

// Check if current date is within the range
if (currentDate >= startDate && currentDate <= endDate) {
    console.log("The game is ongoing!");
